...
- build sequence of opcodes when graph changes
  - topo sort nodes
- preallocate buffers and connect nodes
  - Node has connect_port(label, ptr) method
    - lv2, ladspa, etc. nodes proxy call to plugin
- what about parameters?
- opcodes
  - run_node(node)
  - clear_buffer(bufnum)
  - copy_buffer(src_bufnum, dest_bufnum)
  - merge_buffer(src_bufnum, dest_bufnum)
