...
* Batch instrument db mutations to speed up startup					:ANNOYING:
...
Deep scanning
- Collect more information about instruments and store in InstrumentDescription
- instrument type, path, mtime, copyright, #channels, sample rate, sample format
