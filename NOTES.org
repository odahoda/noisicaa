...
* appending measure does not handle TrackGroups 					     :BUG:
- tracks in a subgroup don't get extended
- extending a track in a subgroup, only extends tracks in master group
