...
* Support mono ports									      :FR:
- Ports specify a list of channels: ['mono'], ['left', 'right'], etc.

* TODO LADSPA support									      :FR:
- how to map stereo connections to the right plugin ports?
* Plugin support									      :FR:
** LV2
