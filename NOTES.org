...
- execptions get swallowed by logging callback?
  - cython tests fail with
    SystemError: <cyfunction TestProcessorSamplePlayer.test_sample_player at 0x7ffff5f68328> returned NULL without setting an error
  - dump to stderr:
    Exception ignored in: 'noisicaa.core.logging.pylogging_cb'
    Traceback (most recent call last):
      File "processor_sample_player_test.pyx", line 66, in noisicore.processor_sample_player_test.TestProcessorSamplePlayer.test_sample_player
