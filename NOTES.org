...
* Muting an audiotrack mutes it parent mixer						     :BUG:
Audio tracks should have a mixer node, too
...
* Samples are show at wrong position when x scale changes				     :BUG:
Stays at the same absolute position on screen
