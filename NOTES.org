...
* Exception when opening InstrumentLibrary						   :CRASH:
Exception in callback:
Callback: <Task finished coro=<BeatTrackProperties.onSelectInstrumentAsync() done,
   defined at /storage/users/pink/projects/noisicaä/noisicaa/ui/track_properties_dock.py:238>
   exception=TypeError("'selection_set' is an unknown keyword argument",)>
...
* SheetView follows playback position 							      :FR:
