...
ProcessorTrackMixer::ProcessorTrackMixer(
    const string& node_id, HostSystem *host_system, const pb::NodeDescription& desc)
  : ProcessorCSoundBase(node_id, "noisicaa.audioproc.engine.processor.track_mixer", host_system, desc) {}

Status ProcessorTrackMixer::setup_internal() {
...
void ProcessorTrackMixer::cleanup_internal() {
