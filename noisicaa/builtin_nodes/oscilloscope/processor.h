...
#ifndef _NOISICAA_BUILTIN_NODES_OSCILLOSCOPE_PROCESSOR_H
#define _NOISICAA_BUILTIN_NODES_OSCILLOSCOPE_PROCESSOR_H
...
class ProcessorOscilloscope : public Processor {
public:
  ProcessorOscilloscope(
...
private:
  ...
  unique_ptr<uint8_t> _node_msg_buffer;
  LV2_Atom_Forge _node_msg_forge;

  atomic<pb::OscilloscopeSpec*> _next_spec;
  atomic<pb::OscilloscopeSpec*> _current_spec;
  atomic<pb::OscilloscopeSpec*> _old_spec;
};
