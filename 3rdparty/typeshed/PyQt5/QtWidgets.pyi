...
class QGraphicsView(QAbstractScrollArea):
    rubberBandChanged = ...  # type: PYQT_SIGNAL
...
class QToolButton(QAbstractButton):
    ...
    def __init__(self, parent: typing.Optional[QWidget] = ..., icon: typing.Optional[QtGui.QIcon] = ..., autoRaise: typing.Optional[bool] = ..., focusPolicy: typing.Optional[QtCore.Qt.FocusPolicy] = ..., checkable: typing.Optional[bool] = ...) -> None: ...
