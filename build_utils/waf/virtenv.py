...
def configure(ctx):
    ...
    # Misc pip packages:
    pip_mgr.check_package(RUNTIME, 'eventfd', version='0.2')
    pip_mgr.check_package(RUNTIME, 'lucky-humanize', version='0.5.4')
    pip_mgr.check_package(RUNTIME, 'numpy', version='1.18.1')
    pip_mgr.check_package(RUNTIME, 'portalocker', version='1.5.2')
    pip_mgr.check_package(RUNTIME, 'posix-ipc', version='1.0.4')
    pip_mgr.check_package(RUNTIME, 'psutil', version='5.6.7')
    pip_mgr.check_package(RUNTIME, 'pyparsing', version='2.4.6')
    pip_mgr.check_package(RUNTIME, 'sortedcontainers', version='2.1.0')
    pip_mgr.check_package(RUNTIME, 'toposort', version='1.5')
    pip_mgr.check_package(RUNTIME, 'urwid', version='2.1.0')
    pip_mgr.check_package(RUNTIME, 'fastjsonschema', version='2.14.2')
    pip_mgr.check_package(RUNTIME, 'mutagen', version='1.44.0')
    pip_mgr.check_package(BUILD, 'cssutils', version='1.0.2')
    pip_mgr.check_package(BUILD, 'Cython', version='0.29.15')
    pip_mgr.check_package(BUILD, 'Jinja2', version='2.11.1')
    pip_mgr.check_package(BUILD, 'PyYAML', version='5.3')
    pip_mgr.check_package(BUILD, 'packaging', version='20.1')
    pip_mgr.check_package(BUILD, 'xunitparser', version='1.3.3')
    pip_mgr.check_package(DEV, 'asynctest', version='0.13.0')
    pip_mgr.check_package(DEV, 'async-generator', version='1.10')
    pip_mgr.check_package(DEV, 'coverage', version='5.0.3')
    pip_mgr.check_package(DEV, 'mox3', version='1.0.0')
    ...
    pip_mgr.check_package(RUNTIME, 'PyGObject', version='3.34.0')
    pip_mgr.check_package(DEV, 'PyGObject-stubs', version='0.0.2')
    ...
    pip_mgr.check_package(DEV, 'dbus-python', version='1.2.16')
